...
import static com.apps.kunalfarmah.omrscanner.Util.sortLeft2Right;
import static com.apps.kunalfarmah.omrscanner.Util.sortTopLeft2BottomRight;
import static com.apps.kunalfarmah.omrscanner.Util.sout;
import static com.apps.kunalfarmah.omrscanner.Util.write2File;
...
public class Scanner {
    ...
    public void scan() throws Exception {
        ...
        for(int index = 0; index < answers.size(); index++){
            ...
            Util.writeToFile(String.valueOf((index + 1) + ". " + (optionIndex == null ? "EMPTY/INVALID" : options[optionIndex])),MainActivity.file);
        }
